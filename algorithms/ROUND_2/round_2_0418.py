...
Stacked improvements over round_2_0417:
- Pepper: dynamic BUY_LIMIT = first_observed_ask + BUY_MARGIN (robust to
  any starting price; static 13008 silently fails if round starts >13008).
- Osmium: microprice-blended mid replaces plain mid (weights toward thin side).

Swept on Round 2 days [-1, 0, 1]: +172 pepper, +79 osmium vs 0417 baseline.
"""
