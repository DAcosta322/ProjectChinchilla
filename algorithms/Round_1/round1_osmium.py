"""ASH_COATED_OSMIUM market-making strategy (adapted from TOMATOES MA).

Osmium characteristics (from ROUND_1 data):
  - Fluctuates around 10000, range ~9976-10026
  - Median spread: 16, typical range 5-21
  - ~8% of ticks have narrow spread (<=13) where a 3rd participant posts inside
  - ~4% of ticks have completely empty bid or ask side
  - ~420 market trades per day, qty 2-10

Strategy: Dual-MA fair value with market-making.
  - Use fast/slow MA crossover to estimate fair value
  - Take mispriced orders when price < fv (buy) or > fv (sell)
  - Post resting orders at fv +/- SPREAD to capture the wide spread
  - Inventory clearing when position exceeds threshold
"""
