"""ASH_COATED_OSMIUM — pure mean-reversion variant (~80% efficiency).

SIGNAL_MULT=0.0 ignores momentum entirely: FV = slow MA only. Trades purely on
the assumption that price reverts to the long-run average. Misses trend profits
but avoids momentum whipsaws.

Backtested PnL: ~9479 (80% of optimal 11779).
"""
