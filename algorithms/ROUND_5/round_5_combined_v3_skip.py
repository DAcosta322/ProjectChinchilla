"""Round 5 baseline = combined_v3 + chronic-loser skip-list.

Strategy: trace combined_v3 (sub 552389 = $23,066 platform) + skip MM on
SLEEP_POD_LAMB_WOOL and ROBOT_DISHES (the 2 products that BT showed losing
every day). NO anchor, NO cooldown, NO own_trades processing — to avoid
the sign-bug + pos≠0 stranded-short pathology that hit v4f.

This is the new known-good platform baseline.
"""
