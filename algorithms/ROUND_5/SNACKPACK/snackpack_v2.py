"""SNACKPACK v2: 2-pair spread MR (drop the bleeding PISTA factor).

v1 ran the 3-factor decomposition; PISTA leg lost $1-2.5K every day on
spread cost (the PISTA-vs-STRAW residual is mostly random walk, not MR).
v2 trades only Pair A (CHOC/VAN) and Pair B (STRAW/RASP) and keeps
PISTA flat.

Rest of mechanics unchanged from v1.
"""
