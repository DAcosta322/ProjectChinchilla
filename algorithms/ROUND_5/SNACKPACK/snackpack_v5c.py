"""SNACKPACK v5c: v4 + faster HL_VAR (adapts to intraday vol regimes).

Pattern analysis showed fA std varies 183->390 within day 2 (2.1x range
across quarters). v4's HL_VAR=8000 averages over the whole day so the
denominator misses regime shifts. v5c uses HL_VAR=1500 to track within-
quarter vol changes.
"""
